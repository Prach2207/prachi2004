...
def issue_db():
    ...
    try:
        ...
        if flag==1:
            ...
            updatequery="update books set available='NO' where id='"+bid +"';"
            print(updatequery)
            cursor.execute(updatequery)
            db.commit()

            sqlquery= "insert into issued values('" + bid +"','" +bStudentName+"' );"
            print(sqlquery)
...
def issueBooks():
    ...
    L = Label(window, font = ('arial', 15, 'bold'), text = "Enter MemberId: ")
